    ...
    <body class="bg-white text-gray-900"></body>
        <div class="bg-white py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
            <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">Februari 2025</span> <span class="text-sm font-medium">Cek Rekonsiliasi</span>
            ...
            <!-- Left Content -->
                <div class="md:w-1/2 space-y-4">
                    ...
                    <h2 class="mb-4 text-left text-2xl font-extrabold tracking-tight leading-none text-primary-900 md:text-5xl lg:text-6xl dark:text-white">Februari 2025</h2>
