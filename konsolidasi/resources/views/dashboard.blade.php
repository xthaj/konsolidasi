...
@section("content")
    ...
    @if (auth()->user()->isPusat())
        @php
            $activeBulanTahun = \App\Models\BulanTahun::where('is_aktif', 1)->first();
            $hasRekonsiliasi = $activeBulanTahun ? \App\Models\Rekonsiliasi::where('bulan_tahun_id', $activeBulanTahun->id)->exists() : false;
        @endphp
        ...
        @else
            ...
            <div class="bg-white">
                <div class="flex flex-col gap-8 md:flex-row items-center justify-center min-h-screen max-w-6xl mx-auto px-6">
                    <!-- Left Content -->
                    <div class="md:w-1/2 space-y-4"></div>
