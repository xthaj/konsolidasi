...
<div x-data="webData" class="container mx-auto p-4">
    ...
    <div class="mb-6">
        <h2 class="text-xl font-semibold mb-2">Bulan dan Tahun Aktif</h2>
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-semibold">Daftar Komoditas</h2>
