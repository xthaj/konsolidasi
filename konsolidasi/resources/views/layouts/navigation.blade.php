                ...
                <li>
                    ...
                    <div id="dropdownLogout" class="z-15 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
                        <div class="px-4 py-3">
                            ...
                            <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">{{ auth()->user()->wilayah_nama_display }}</span>
                            <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">{{ auth()->user()->level_nama }}</span>
                        </div>
