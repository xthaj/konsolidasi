    ...
    <div id="{{ $id }}" class="z-10 hidden bg-white rounded-lg shadow-sm w-60 ">
        ...
        <div class="p-3">
            ...
            <div class="relative">
                ...
                <input type="text" id="input-group-search-{{ $id }}" @input="{{ $search }}($event.target.value)" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5 dark:bg-gray-600 dark:border-gray-500  dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search {{ strtolower($label) }}">
            </div>
        </div>
        @endif
