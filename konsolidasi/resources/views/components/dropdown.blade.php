...
<div>
    ...
    <button id="{{ $id }}Button" data-dropdown-toggle="{{ $id }}" class="w-full inline-flex items-center justify-between px-4 py-2 text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="button">
        {{ $label }}
    ...
    <!-- Dropdown menu -->
    <div id="{{ $id }}" class="z-10 hidden bg-white rounded-lg shadow-sm w-60 dark:bg-gray-700">
        @if ($search)
            <div class="p-3">
